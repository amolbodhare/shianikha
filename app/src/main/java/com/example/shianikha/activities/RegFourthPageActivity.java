...
public class RegFourthPageActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private ArrayList<String> occupationNameList, ocupationCodeList;
    ...
    private void setUpCustomSpinner(final View view) {
        ...
        if (view.getId() == R.id.fatherOccupationEditText) {
            ((EditText) findViewById(R.id.editText)).setHint("Search Fathers Occupation");
            arrayAdapter = new ArrayAdapter<>(this, R.layout.text_view, R.id.textView, occupationNameList);
        }
        else if (view.getId() == R.id.motherOccupationEditText) {
            ((EditText) findViewById(R.id.editText)).setHint("Search Mothers education");
            arrayAdapter = new ArrayAdapter<>(this, R.layout.text_view, R.id.textView, occupationNameList);
        }
    ...
    private void makeJson() {
        ...
        EditText editText = ((EditText) findViewById(R.id.fatherName));
        ...
        if (i != -1)
            App.masterJson.addString(P.father_occupation_id, ocupationCodeList.get(i));
        ...
        if (i != -1)
            App.masterJson.addString(P.mother_occupation_id, ocupationCodeList.get(i));
